...
export default function ComponentHolder({ children, code, title }) {
  ...
  return (
    <div className="py-12">
      <div className="bg-gray-50 dark:bg-primary-600 dark:text-white overflow-hidden shadow rounded-lg">
        ...
        {showCode ? (
          ...
          <div className="bg-gray-100 dark:bg-primary-700 px-4 py-5 sm:p-6">
            {children}
          </div>
        )}
      </div>
